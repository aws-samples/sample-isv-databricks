...
- **Local tools:** AWS CLI **v2.36.2+** (the Amazon Quick `create-flow`/`create-data-source`/
  `create-space` verbs require a recent release), the **Databricks CLI v0.299.0+**, `jq`, and `uv` (or
